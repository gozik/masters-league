...
def show_season_application():
    ...
    division_notes = {
        'M1': ['Общая группа 12 участников', 'Добор 2 участников по итогам квалификаций', '+1 участник по итогам 5 недель'],
        'M2': ['Общая группа 14 участников',
               'Квалификация: 2 наверх, добор 2 снизу',
               'Быстрый перевод топ-1 по итогам 5 недель',],
        'M3': ['Две группы по 9-10 участников',
               'Квалификация: 2 наверх, добор 6 снизу',
               'Быстрый перевод топ-1 по итогам 5 недель', ],
        'M4': ['Две группы по 10 участников',
               'Квалификация: 6 наверх, добор 5 снизу',
               'Быстрый перевод топ-1 по итогам 5 недель', ],
        'M5': ['ве группы по 10-12 участников',
               'Квалификация: 5 наверх',
               'Быстрый перевод топ-1 по итогам 5 недель', ],
    }
