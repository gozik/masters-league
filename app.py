...
def show_season_application():
    ...
    division_notes = {
        ...
        'M3': ['Две группы по 9-10 участников',
               'Квалификация: 4 наверх, добор 4 снизу',
               'Быстрый перевод топ-1 по итогам 5 недель', ],
        'M4': ['Две группы по 13 участников',
               'Квалификация: 4 наверх, добор 7 снизу',
               'Быстрый перевод топ-1 по итогам 5 недель', ],
        'M5': ['Общая группа 14 участников',
               'Квалификация: 7 наверх',
               'Быстрый перевод топ-1 по итогам 5 недель', ],
    }
