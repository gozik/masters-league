...
def show_season_application():
    ...
    division_notes = {
        ...
        'M1': ['Общая группа 10 участников', 'Добор 3 участников по итогам квалификаций', '+2 участника по итогам 5 недель'],
        'M2': ['Общая группа 12 участников',
               'Квалификация: 3 наверх, добор 3 снизу',
               'Быстрый перевод топ-2 по итогам 5 недель',],
        'M3': ['Общая группа 14 участников',
               'Квалификация: 3 наверх, добор 4 снизу',
               'Быстрый перевод топ-2 по итогам 5 недель', ],
        'M4': ['Две группы по 10 участников',
               'Квалификация: 4 наверх, добор 10 снизу',
               'Быстрый перевод топ-1 по итогам 5 недель', ],
        'M5': ['Общая группа 10 участников',
               'Квалификация: 10 наверх',
               'Быстрый перевод топ-1 по итогам 5 недель', ],
    }
