...
SEASONS_INFO = {
    ...
    12: {
            ...
            'prize_positions': ['Все дивизионы: 1, 2, 3 места'],
            'prize_amount': 600000,
            'lottery_minimum_matches': 7,
            'lottery_amount': 300000,
            'lottery_count': 12,
            'relegations': {'M1': ['повышение до SemiPro: top-1', 'понижение: bottom-5'],
                        'M2a / M2b': ['повышение: top-3', 'понижение: bottom-4'],
                        'M3a / M4b': ['повышение: top-3', 'понижение: bottom-3'],
                        'M4': ['повышение: top-4', 'понижение: bottom-4'],
                        'M5': ['повышение: top-4'],
                        },
            'special_rules': ['Первые две недели - квалификационный раунд',
                              'Дивизионы M2 и M3 разбиты на 2 подгруппы',
                              '25.04.26 - Ранний переход наверх для лидеров групп M2 и M3, а также top-2 из M4, M5',
                              'При использовании раннего перехода количество мест на повышение сокращается по количеству перешедших из дивизиона',
                              ],
            'description': 'Весенний сезон 2026',
            'is_completed': True,
            'is_ranked': True,
    },
    13: {
            ...
            'cost': 250000,
            'raketo_ref': 'https://raketo.app.link/iUDvty91c3b',
            'prize_positions': [],
            'prize_amount': 600000,
            'lottery_minimum_matches': 7,
            'lottery_amount': 300000,
            'lottery_count': 14,
            'relegations': {'M1': ['понижение: bottom-5'],
                        'M2a / M2b': ['повышение: top-3', 'понижение: bottom-4'],
                        'M3a / M4b': ['повышение: top-3', 'понижение: bottom-4'],
                        'M4a / M4b': ['повышение: top-3', 'понижение: bottom-4'],
                        'M5': ['повышение: top-6'],
                        },
            'special_rules': ['Первые две недели - квалификационный раунд',
                              'Дивизионы M2, M3, M4 разбиты на 2 подгруппы',
                              '11.07.26 - Ранний переход наверх для лидеров групп M2-M5',
                              'При использовании раннего перехода количество мест на повышение сокращается по количеству перешедших из дивизиона',
                              'Для дивизиона M5 введен лимит на максимальное количество очков и количества матчей для тайбрейкера (10)'],
            'description': 'Летний сезон 2026',
            'is_completed': False,
            'is_ranked': True,
    },
    14: {
            ...
            'special_rules': ['Первые две недели - квалификационный раунд',
                              'Деление дивизионов по рейтингу на 2 половины (M10 + M15)'],
            'description': 'Осенний сезон 2026',
            'is_completed': False,
            'is_ranked': True,
    },
}
