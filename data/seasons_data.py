...
SEASONS_INFO = {
    ...
    9: {
            ...
            'cost': 130000,
            'raketo_ref': 'https://raketo.app.link/mZ5W5yEi2Yb',
            'prize_positions': ['Все дивизионы: 1, 2 места'],
            'prize_amount': 300000,
            'lottery_minimum_matches': 7,
            'lottery_amount': 200000,
            'lottery_count': 4,
            'relegations': {
                        'M1': ['понижение: bottom-3'],
                        'M2': ['повышение: top-3', 'понижение: bottom-3'],
                        'M3': ['повышение: top-3', 'понижение: bottom-3'],
                        'M4': ['повышение: top-3', 'понижение: bottom-3'],
            },
            'special_rules': ['Допускается розыгрыш одного сета по правилам Open лиги, необходимо согласовать формат матча с соперником до его начала'],
