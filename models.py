...
class Match(db.Model):
    ...
    def score_summary(self):
        ...
        if self.set1_player1 is not None and self.set1_player2 is not None:
            ...
            if self.tb1_player1 is not None and self.tb1_player2 is not None:
        ...
        if self.set2_player1 is not None and self.set2_player2 is not None:
            ...
            if self.tb2_player1 is not None and self.tb2_player2 is not None:
        ...
        if self.set3_player1 is not None and self.set3_player2 is not None:
            ...
            if self.tb3_player1 is not None and self.tb3_player2 is not None:
    ...
    for match in matches:
        ...
        if is_player1_match_player1:
            ...
            sets_won = sum([
                ...
                1 if match.set2_player2 and match.set2_player2 > match.set2_player1 else 0,
